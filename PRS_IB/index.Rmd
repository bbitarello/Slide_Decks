---
title: "Investigando a falta de transferibilidade de scores de risco poligênico em coortes com ancestralidade não-Europeia e miscigenada"
...
```{r, out.width = "160px",echo=FALSE, eval=T}
knitr::include_graphics("meat/xaringan.png")
```
