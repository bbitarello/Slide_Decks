...
### .pink[1)] How has ***evolution** shaped genetic diversity?

--

### .pink[2)] What are some of the ***most diverse*** genetic systems] known and ***how*** did they evolve?
...
---
class: center, top
# A polymorphism is a _variable site_ in the genome _across individuals_
...
## Balancing selection _maintains diversity_ in populations
```{r, out.width = "1000px",echo=FALSE, eval=T}
...
## Sometimes, it may be _beneficial_ to have _deleterious variants_
...
## .pink[Project 1: Balancing selection in the MHC]

## .lilac[Project 2: Balancing selection in the human genome]
...
### .pink[1)] How has _evolution_ shaped genetic diversity?


### .pink[2)] What are some of the _most diverse_ genetic systems known and *how* did they evolve?
???
Let's start by focusing on the most diverse region of the vertebrate genome: the MHC
---
class: center, top
## The MHC is the _most genetically diverse_ region of the genome
...
---
class: center, top
## The MHC is an _extreme example_ of _balancing selection_
...
# Do ***all heterozygotes*** have the same fitness?

# Do genotypes with _more diverse alleles_ have a larger advantage?
...
---
class: center, top
## _Stronger_ evidence of balancing selection _between allelic lineages_
...
## .lilac[Project 1: Balancing selection in the MHC]

## .pink[Project 2: Balancing selection in the human genome]
...
# _How prevalent_ has balancing selection been throughout human evolution? 

# What are the instances _beyond the MHC_ loci?

# What are the _common trends_ among the target
...
### Goal 1: detect balancing selection in the human genome

#### .pink[Approach:] combine its two main signals into one statistic
???
...
### Goal 2: quantify its occurrence  throughout human evolution?

#### .pink[Approach:] perform a genome-wide scan using our test 
...
### Goal 3: Describe the candidate genes/regions

#### .pink[Approach:] Verufy whether they are coding, regulatory, functions of the genes, etc
...
## Balancing selection increases _proportions of polymorphic sites_ and _intermediate frequency alleles_
...
---
class:left, top
## Our test was more _powerful_, more _efficient_ and _faster_ than previous models
...
## Balancing selection has been _more common_ than previously thought and targeted genes with many functions
...
## .pink[Research Project 3: Polygenic scores in diverse populations]
...
## Polygenic risk scores combine _all variants_ with a phenotypic effect
...
## How do these _different factors_ affect prediction accuracy?


## What can we _do_ about it?]
...
---
class:left, top
## Predicting a highly heritable trait in diverse populations
...
---
class:left, top
## Power to predict height increases with proportion of European ancestry
```{r, out.width = "1000px",echo=FALSE, eval=T}
...
???
A brief recap of what I presented in those three research projects. These were the main questions.
---
class: middle, left
