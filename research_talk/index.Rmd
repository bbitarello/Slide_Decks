...
???
this is obviously not ideal and reflects many biases which I don't have time to go into to, but considering the hype i showed about PRS before, how does this affect popygenic risk score predictions? If personalized genomics are to became a part of medical care, we need be sure that we understand how these predictions work for the mostly unsampled populations of the world.

This figure from Martin et al showes average prediction accuracies for 17 traits, using GWAS summary statisticas derived from 100% European cohorts. I am not sure what american means? As you can see, relative to the European ancestrie, all the other ancestries see a much reduced prediction accuracy for all traits
