...
Tarsila do Amaral (1933) [Source: www.wikiart.org]
...
### .pink[3)] What are the .lilac[consequences of genetic diversity] and its link to complex diseases?
...
???
In a sense, the main questions that drive my research interests have this common thread.What evolutionary processes shape genetic diversity? What examples do we have of extremely diverse systems and what do they tell us about selective pressures? Are these consequences to such diversity, i.e, the presence of 'common variants' that predispose us to disease? And, finally, since it seems inevitable that we are headed towards personalized genomic medicine, can it be done in a fair way?
---
class: middle, left
...
???
Conclusion: stronger balancing selection shaping diversity between allelic lineages than between

This supports the divergent allele advantage model proposed by Wakeland (1990)
---
class: middle, left
...
## Genomic .lilac[signatures] of balancing selection
