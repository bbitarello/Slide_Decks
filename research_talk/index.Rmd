---
title: "Genetic diversity in humans: evolutionary and medical perspectives"
...
* Polygenic risk scores have very little use for individuals with non-European ancestry
  - bigger, more diverse GWAS
  - methods
  - understand environment effects
...
```{r, out.width = "260px",echo=FALSE, eval=T}
knitr::include_graphics("kaufman-logo-tag.png")
```
```{r, out.width = "200px",echo=FALSE, eval=T}
...
```
```{r, out.width = "180px",echo=FALSE, eval=T}
