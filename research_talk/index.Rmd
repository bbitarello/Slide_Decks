...
### .pink[3)] What are the ***consequences*** of genetic diversity] and their link to common diseases?
???
Are these consequences to such diversity, i.e, the presence of 'common variants' that predispose us to disease? 
--

### .pink[4)] Can we ***predict complex phenotypes*** using genetics in an equitable way that encompasses all of human genetic diversity?
...
---
class: center, top
# A polymorphism is a ***variable site*** in the genome within a species
...
# Balancing selection ***maintains diversity*** in populations
```{r, out.width = "1000px",echo=FALSE, eval=T}
...
# Sometimes, it may be ***beneficial*** to have ***deleterious variants***
...
### .pink[2)] What are some of the most diverse genetic systems known and how did they evolve to be so diverse?
???
Let's start by focusing on the most diverse region of the vertebrate genome: the MHC
---
class: center, top
# The MHC is the ***most diverse*** genomic region
...
---
class: center, top
# The MHC is an ***extreme example*** of ***balancing selection***
...
# Do genotypes with ***more diverse alleles*** have a greater advantage?
...
---
class: center, top
# ***Stronger*** evidence of balancing selection ***between*** allelic lineages
...
# ***How prevalent*** has balancing selection been throughout human evolution? 

# What are the instances ***beyond the MHC*** loci?
...
#### .pink[Approach:] Verify whether they are coding, regulatory, functions of the genes, etc
...
## Balancing selection increases ***proportions of polymorphic sites*** and ***intermediate frequency*** alleles
...
---
class:left, top
## NCD2 was more _powerful_, more _efficient_ and _faster_ than previous models
...
## Balancing selection has been ***more common*** than previously thought
...
class: center, top
# Genome-wide association studies detect **.pink[genetic associations]** to traits of interest
...
## How do these _.pink[different factors]_ affect prediction accuracy?
...
```{r, out.width = "960px",echo=FALSE, eval=T}
