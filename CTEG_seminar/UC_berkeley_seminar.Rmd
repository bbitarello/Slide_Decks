...
class: center, top
## Most complex traits are polygenic
...
---
class: left, middle
* height: 25% ($\sim3,000$ SNPs)


* schizophrenia: 7% ($\sim 100$ SNPs)

* breast cancer: AUC=0.65 ($\sim100$ SNPs)

* ADHD: 5.5% ($\sim100$ SNPs)

* Cardiovascular disease(CAD): AUC=81 ($\sim6,000$ SNPs)
...
Assumptions: independence, additive model
---
class: top, center
# PRSs are appealing
...
--
![](cad.png)
.pull-left[.full-width[Khera *et. al* (2019) *Nat Genet.*]]
...
* age, sex, SES of cohort  [Mostafavi et al. (2020) eLife]
...
PRS -> Phenotype **means** genetic cause
--
...
## Mendelian randomization still needed
![](Screen Shot 2020-09-16 at 10.27.24 PM.png)
...
.pull-right[.full-width[Martin et al. (2019) Nat Genetc]]
---
class: top, left
...
# How does ancestry impact prediction accuracy?
.pull-left[.full-width[
...
---
class:top, left
##Differences in true effect size?
--
...
* genetic correlations are high when available

--

But...what really matters is the .large[**marginal**] effect sizes
---
class: center
##Differences in **marginal** effect sizes?
