...
.pull-left[.fix-width[
```{r, out.width = "570px",echo=FALSE, eval=T}
knitr::include_graphics("LD_cartoon.001.png")
```
]]
.pull-right[.fix-width[
```{r, out.width = "570px",echo=FALSE, eval=T}
knitr::include_graphics("LD_cartoon.002.png")
```
]]
###**Similar** slopes
...
.pull-left[.fix-width[
```{r, out.width = "600px",echo=FALSE, eval=T}
knitr::include_graphics("LD_cartoon2.001.png")
```
]]
.pull-right[.fix-width[
```{r, out.width = "600px",echo=FALSE, eval=T}
knitr::include_graphics("LD_cartoon2.002.png")
```
]]
###**Different** slopes
