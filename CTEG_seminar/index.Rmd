...
.pull-right[.full-width[
```{r, out.width = "470px",echo=FALSE, eval=T}
knitr::include_graphics("pheno_var.png")
```
...
---
class: top, center
### **Prediction:** better tagging of causal variants should decrease loss-of-accuracy(LOA)
--
...
.pull-left[.full-width[
```{r, out.width = "670px",echo=FALSE, eval=T}
knitr::include_graphics("Screen Shot 2020-09-16 at 4.28.28 PM.png")
```
]]
...
.pull-right[.full-width[
```{r, out.width = "670px",echo=FALSE, eval=T}
knitr::include_graphics("Screen Shot 2020-09-16 at 4.28.34 PM.png")
```
...
---
class: top, center
##Difference in marginal effect sizes **increases** with allele frequency differences across ancestries 
.pull-left[.full-width[
```{r, out.width = "670px",echo=FALSE, eval=T}
...
---
class: center
###Modest improvement when using **linear combinations of ancestry-specific** PRS
...
```{r, out.width = "230px",echo=FALSE, eval=T}
