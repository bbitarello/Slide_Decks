...
---
class: top, left
# Allele frequencies explains up to .weirdbrown[20% of oLOA]
...
---
class: top, center
# No significant differences in .weirdbrown[phenotypic variance]
...
.pull-right[.full-width[
```{r, out.width = "330px",echo=FALSE, eval=T}
...
### **Observation:** Imputation doesn't influence .weirdbrown[LOA]
---
class: top, left
...
.pull-left[.full-width[
```{r, out.width = "610px",echo=FALSE, eval=T}
...
###**Observation:** Difference in effect sizes .weirdbrown[increase] with .weirdbrown[allele frequency differences across ancestries]
---
class: center
##Assuming there .weirdbrown[are differences] in .weirdbrown[marginal effect sizes
